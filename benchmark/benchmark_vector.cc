...
//BENCHMARK_TEMPLATE(BM_resize, int8_t, default_init_allocator<int8_t>)->RangeMultiplier(2)->Range(8, 8<<10);
//BENCHMARK_TEMPLATE(BM_resize, uint8_t, default_init_allocator<uint8_t>)->RangeMultiplier(2)->Range(8, 8<<10);
