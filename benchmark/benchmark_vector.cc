...
BENCHMARK_TEMPLATE(BM_raw_vector_move, uint8_t, int8_t)
    ->RangeMultiplier(8)
    ->Range(1, 8 << 10);
BENCHMARK_TEMPLATE(BM_vector_move, uint8_t, int8_t)
    ->RangeMultiplier(8)
    ->Range(1, 8 << 10);
BENCHMARK_TEMPLATE(BM_raw_vector_move, uint8_t, uint8_t)
    ->RangeMultiplier(8)
    ->Range(1, 8 << 10);
BENCHMARK_TEMPLATE(BM_vector_move, uint8_t, uint8_t)
    ->RangeMultiplier(8)
    ->Range(1, 8 << 10);
BENCHMARK_TEMPLATE(BM_raw_vector_move, uint8_t, char)
    ->RangeMultiplier(8)
    ->Range(1, 8 << 10);
BENCHMARK_TEMPLATE(BM_vector_move, uint8_t, char)
    ->RangeMultiplier(8)
    ->Range(1, 8 << 10);
BENCHMARK_MAIN();
