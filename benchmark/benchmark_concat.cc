...
struct prepare {
    ...
    prepare()
            : col_5_10(4096, {1, 0, 0, 0, 0, 0}, 5, 10),
              ...
              columns_10_10{std::shared_ptr<BinaryColumn>(new BinaryColumn(col_5_10.binary_column)),
                            std::shared_ptr<BinaryColumn>(new BinaryColumn(col_5_10.binary_column))},
              columns_10_20{std::shared_ptr<BinaryColumn>(new BinaryColumn(col_5_10.binary_column)),
                            std::shared_ptr<BinaryColumn>(new BinaryColumn(col_10_20.binary_column))},
              columns_10_100{std::shared_ptr<BinaryColumn>(new BinaryColumn(col_5_10.binary_column)),
                             std::shared_ptr<BinaryColumn>(new BinaryColumn(col_50_100.binary_column))},
              columns_10_500{std::shared_ptr<BinaryColumn>(new BinaryColumn(col_5_10.binary_column)),
                             std::shared_ptr<BinaryColumn>(new BinaryColumn(col_100_500.binary_column))},
              columns_20_100{

                      std::shared_ptr<BinaryColumn>(new BinaryColumn(col_10_20.binary_column)),
                      std::shared_ptr<BinaryColumn>(new BinaryColumn(col_50_100.binary_column))},
              columns_20_500{std::shared_ptr<BinaryColumn>(new BinaryColumn(col_10_20.binary_column)),
                             std::shared_ptr<BinaryColumn>(new BinaryColumn(col_100_500.binary_column))
