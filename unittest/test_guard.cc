...
TYPE_GUARD(SignedIntegerGuard, is_signed_integer, int8_t, int16_t, int32_t, int64_t, int128_t)
TYPE_GUARD(UnsignedIntegerGuard, is_unsigned_integer, uint8_t, uint16_t, uint32_t, uint64_t, uint128_t)
...
UNION_TYPE_GUARD(IntegerGuard, is_integer, is_signed_integer_struct, is_unsigned_integer_struct)
UNION_TYPE_GUARD(NumberGuard, is_number, is_integer_struct, is_bool_struct, is_float_struct)
...
template <typename T>
struct ReturnString<T, FloatGuard<T>> {
    static inline std::string get() { return "float"; }
};

template <typename T>
struct ReturnString<T, IntegerGuard<T>> {
    static inline std::string get() { return "integer"; }
};

template <typename T>
struct ReturnString<T, BoolGuard<T>> {
    static inline std::string get() { return "bool"; }
};

template <typename T>
struct ReturnString<T, DecimalGuard<T>> {
    static inline std::string get() { return "decimal"; }
};

template <typename T>
struct ReturnString<T, CharGuard<T>> {
...
VALUE_GUARD(DB_TYPE, IntegerTypeGuard, is_integer_type, DB_TYPE_TINYINT, DB_TYPE_SMALLINT, DB_TYPE_INT, DB_TYPE_BIGINT,
            DB_TYPE_LARGEINT);
VALUE_GUARD(DB_TYPE, FloatTypeGuard, is_float_type, DB_TYPE_FLOAT, DB_TYPE_DOUBLE)
VALUE_GUARD(DB_TYPE, DecimalTypeGuard, is_decimal_type, DB_TYPE_DECIMAL32, DB_TYPE_DECIMAL64, DB_TYPE_DECIMAL128)
VALUE_GUARD(DB_TYPE, CharTypeGuard, is_char_type, DB_TYPE_CHAR, DB_TYPE_VARCHAR)
UNION_VALUE_GUARD(DB_TYPE, NumberTypeGuard, is_number_type, is_bool_type_struct, is_integer_type_struct,
                  is_float_type_struct);
UNION_VALUE_GUARD(DB_TYPE, NumericTypeGuard, is_numeric_type, is_number_type_struct, is_decimal_type_struct)
...
template <DB_TYPE Type, typename = guard::Guard>
struct ReturnStringV {
    static inline std::string get() { return "unknown"; }
};

template <DB_TYPE Type>
struct ReturnStringV<Type, FloatTypeGuard<Type>> {
    static inline std::string get() { return "float"; }
};

template <DB_TYPE Type>
struct ReturnStringV<Type, IntegerTypeGuard<Type>> {
    static inline std::string get() { return "integer"; }
};

template <DB_TYPE Type>
struct ReturnStringV<Type, BooleanTypeGuard<Type>> {
    static inline std::string get() { return "bool"; }
};

template <DB_TYPE Type>
struct ReturnStringV<Type, DecimalTypeGuard<Type>> {
    static inline std::string get() { return "decimal"; }
};

template <DB_TYPE Type>
struct ReturnStringV<Type, CharTypeGuard<Type>> {
    static inline std::string get() { return "char"; }
};
