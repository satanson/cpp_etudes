...
int main(int argc, char** argv) {
    ...
    std::cout << std::showbase << std::hex << "x=" << x << ", y=" << y << ", res=" << res << ", carry=" << carry
              << std::endl;
    int128_wrapper w;
    auto c = op.asm_mul(x, y, w);
    std::cout << std::showbase << std::hex << "low=" << w.s.low << ", high=" << w.s.high << ", c=" << c << std::endl;
    int128_wrapper wx;
    int128_wrapper wy;
    int128_wrapper wz;
    ...
    std::cout << std::showbase << std::hex << " high=" << wz.s.high << ", low=" << wz.s.low << ", o=" << o << std::endl;
