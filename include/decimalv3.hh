...
template <typename T> constexpr bool is_underlying_type_of_decimal = false;
template <> constexpr bool is_underlying_type_of_decimal<int32_t> = true;
template <> constexpr bool is_underlying_type_of_decimal<int64_t> = true;
template <> constexpr bool is_underlying_type_of_decimal<int128_t> = true;
