...
#define META_MACRO_CASE_DEF_DECOMPOSE_SEP_HELPER(name, sep, n, m, m0, m1, m2,  \
  ...
  META_MACRO_SEP_##sep META_MACRO_CASE_DEF_PART1_HELPER1(name##m1, n, m0, m1,  \
                                                         m2, ##__VA_ARGS__)    \
      META_MACRO_SEP_##sep META_MACRO_CASE_DEF_PART2_HELPER1(                  \
          name##m2, n, m0, m1, m2, ##__VA_ARGS__)

#define META_MACRO_CASE_DEF_DECOMPOSE_HELPER(name, sep, n, m, m0, m1, m2, ...) \
  META_MACRO_CASE_DEF_DECOMPOSE_SEP_HELPER(name, sep, n, m, m0, m1, m2,        \
                                           ##__VA_ARGS__)
...
#define DEF_BINARY_RELATION_ENTRY_1_VARY_0(ctor, b, a)                         \
  DEF_BINARY_RELATION_ENTRY_1_VARY_1(ctor, a, b)

#define DEF_BINARY_RELATION_ENTRY_1_VARY_HELPER(macro_name, ctor, a, b0)       \
  macro_name(ctor, a, b0)

#define DEF_BINARY_RELATION_ENTRY_1(varg_pos, ctor, sep, a, b0)                \
  DEF_BINARY_RELATION_ENTRY_1_VARY_HELPER(                                     \
      DEF_BINARY_RELATION_ENTRY_1_VARY_##varg_pos, ctor, a, b0)
...
#define DEF_BINARY_RELATION_ENTRY_4_SEP_HELPER(varg_pos, ctor, sep, a, b0, b1, \
                                               b2, b3)                         \
  DEF_BINARY_RELATION_ENTRY_2(varg_pos, ctor, sep, a, b0, b1)                  \
  META_MACRO_SEP_##sep DEF_BINARY_RELATION_ENTRY_2(varg_pos, ctor, sep, a, b2, \
                                                   b3)
...
#define DEF_BINARY_RELATION_ENTRY_3(varg_pos, ctor, sep, a, ...)               \
  META_MACRO_CASE_DEF(DEF_BINARY_RELATION_ENTRY_, sep, 4, varg_pos, ctor, sep, \
                      a, ##__VA_ARGS__)
...
#define DEF_BINARY_RELATION_ENTRY_SEP_VARY(varg_pos, ctor, sep, a, ...)        \
  META_MACRO_SELECT(DEF_BINARY_RELATION_ENTRY_, 4, varg_pos, ctor, sep, a,     \
                    ##__VA_ARGS__)

#define DEF_BINARY_RELATION_ENTRY_SEP_NONE(varg_pos, ctor, a, ...)             \
  DEF_BINARY_RELATION_ENTRY_SEP_VARY(varg_pos, ctor, NONE_MARK, a,             \
                                     ##__VA_ARGS__)

#define DEF_BINARY_RELATION_ENTRY_SEP_COMMA(varg_pos, ctor, a, ...)            \
  DEF_BINARY_RELATION_ENTRY_SEP_VARY(varg_pos, ctor, COMMA_MARK, a,            \
                                     ##__VA_ARGS__)

#define DEF_BINARY_RELATION_ENTRY_SEP_SEMICOLON(varg_pos, ctor, a, ...)        \
  DEF_BINARY_RELATION_ENTRY_SEP_VARY(varg_pos, ctor, SEMICOLON_MARK, a,        \
                                     ##__VA_ARGS__)
...
#define DEF_TERNARY_RELATION_ENTRY_1_VARY_1(ctor, a, c, b)                     \
  DEF_TERNARY_RELATION_ENTRY_1_VARY_2(ctor, a, b, c)

#define DEF_TERNARY_RELATION_ENTRY_1_VARY_0(ctor, b, c, a)                     \
  DEF_TERNARY_RELATION_ENTRY_1_VARY_2(ctor, a, b, c)

#define DEF_TERNARY_RELATION_ENTRY_1_VARY_HELPER(macro_name, ctor, a, b, c)    \
  macro_name(ctor, a, b, c)

#define DEF_TERNARY_RELATION_ENTRY_1(varg_pos, ctor, sep, a, b, c)             \
  DEF_TERNARY_RELATION_ENTRY_1_VARY_HELPER(                                    \
      DEF_TERNARY_RELATION_ENTRY_1_VARY_##varg_pos, ctor, a, b, c)

#define DEF_TERNARY_RELATION_ENTRY_2_SEP_HELPER(varg_pos, ctor, sep, a, b, c0, \
                                                c1)                            \
  DEF_TERNARY_RELATION_ENTRY_1(varg_pos, ctor, sep, a, b, c0)                  \
  META_MACRO_SEP_##sep DEF_TERNARY_RELATION_ENTRY_1(varg_pos, ctor, sep, a, b, \
                                                    c1)
...
#define DEF_TERNARY_RELATION_ENTRY_4_SEP_HELPER(varg_pos, ctor, sep, a, b, c0, \
                                                c1, c2, c3)                    \
  DEF_TERNARY_RELATION_ENTRY_2(varg_pos, ctor, sep, a, b, c0, c1)              \
  META_MACRO_SEP_##sep DEF_TERNARY_RELATION_ENTRY_2(varg_pos, ctor, sep, a, b, \
                                                    c2, c3)

#define DEF_TERNARY_RELATION_ENTRY_4(varg_pos, ctor, sep, a, b, c0, c1, c2,    \
                                     c3)                                       \
  DEF_TERNARY_RELATION_ENTRY_4_SEP_HELPER(varg_pos, ctor, sep, a, b, c0, c1,   \
                                          c2, c3)

#define DEF_TERNARY_RELATION_ENTRY_3(varg_pos, ctor, sep, a, b, ...)           \
  META_MACRO_CASE_DEF(DEF_TERNARY_RELATION_ENTRY_, sep, 5, varg_pos, ctor,     \
                      sep, a, b, ##__VA_ARGS__)
...
#define DEF_TERNARY_RELATION_ENTRY_SEP_VARY(ctor, sep, varg_pos, a, b, ...)    \
  META_MACRO_SELECT(DEF_TERNARY_RELATION_ENTRY_, 5, varg_pos, ctor, sep, a, b, \
                    ##__VA_ARGS__)

// separated by semicolon(,) mark
#define DEF_TERNARY_RELATION_ENTRY_SEP_COMMA(ctor, varg_pos, a, b, ...)        \
  DEF_TERNARY_RELATION_ENTRY_SEP_VARY(ctor, COMMA_MARK, varg_pos, a, b,        \
                                      ##__VA_ARGS__)

// separated by semicolon(;) mark
#define DEF_TERNARY_RELATION_ENTRY_SEP_SEMICOLON(ctor, varg_pos, a, b, ...)    \
  DEF_TERNARY_RELATION_ENTRY_SEP_VARY(ctor, NONE_MARK, varg_pos, a, b,         \
                                      ##__VA_ARGS__)
