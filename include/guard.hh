...
template <typename T, template <typename> typename... TypePredicates>
struct TypeGuardUnionStruct {
    static constexpr bool t = type_union<T, TypePredicates...>;
    using Type = std::enable_if_t<t, guard::Guard>;
};

template <typename T, template <typename> typename... TypePredicates>
using TypeGuardUnion = typename TypeGuardUnionStruct<T, TypePredicates...>::Type;

template <typename T, T v, template <T> typename... ValuePredicates>
constexpr bool value_union = OrValuePredicates<T, v, ValuePredicates...>::value;
template <typename T, T v, template <T> typename... ValuePredicates>
struct ValueGuardUnionStruct {
    static constexpr bool t = value_union<T, v, ValuePredicates...>;
    using Type = std::enable_if_t<t, guard::Guard>;
};
template <typename T, T v, template <T> typename... ValuePredicates>
using ValueGuardUnion = typename ValueGuardUnionStruct<T, v, ValuePredicates...>::Type;
