...
// compatible with the C language (POD types) are trivially destructible." Types
// with trivial destructors is safe when when move content from a RawVector<T>
// into a std::vector<U> and both T and U the same bit width, i.e.
// doris::raw::RawVector<int8_t> a;
// a.resize(100);
// std::vector<uint8_t> b =
// std::move(reinterpret_cast<std::vector<uint8_t>&>(a));
