...
static inline const char* utf8_reverse_per_slice(const char* src_begin, const char* src_end,
...
static inline const char *ascii_reverse(const char *src_begin, const char *src_end,
                                        const char *dst_begin) {
  auto p = src_begin;
  auto const size = src_end - src_begin;
  char *q = (char *) dst_begin + size;
